...
$this->title = Yii::t('app', 'Clients && Staff Members');
...
<div class="members-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Create Member'), ['create-both'], ['class' => 'btn btn-success']) ?>
    </p>
