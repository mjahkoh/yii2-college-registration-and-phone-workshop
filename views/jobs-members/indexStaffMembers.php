...
<div class="members-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Create Staff Member'), ['create-staff-members'], ['class' => 'btn btn-success']) ?>
    </p>
		   ...
		   [
				...
				'buttons' => [
					'view' => function ($url, $model) {
						$url = [
							'/members/view-staff-members', 'id' => $model['id']
						];
							return Html::a('', $url, ['title'=>'View Staff Member', 'class'=>'glyphicon glyphicon-eye-open']);
					},
					'update' => function ($url, $model) {
						$url = [
							'/members/update-staff-members', 'id' => $model['id']
						];
							return Html::a('', $url, ['title'=>'Update Staff Member', 'class'=>'glyphicon glyphicon-pencil']);
					},
					'delete' => function ($url, $model) {
							$url = [
								'/members/delete-staff-members' , 'id' => $model['id']
							];
							return Html ::a( '' , $url, [
